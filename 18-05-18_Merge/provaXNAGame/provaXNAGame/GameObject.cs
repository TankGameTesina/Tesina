...
namespace provaXNAGame
{
    public class GameObject:BaseObject 
    {
        ...
        public GameObject(Rectangle posizione, Vector2 pos)
        {
            BoundingBox = posizione;
            Position = pos;
        }

        public GameObject(Rectangle posizione)
        {
            BoundingBox = posizione;
        }

        public virtual void Init(Vector2 pos, Texture2D text, Texture2D txBullet, String username, string address)
        {
